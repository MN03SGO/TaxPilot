            ...
            <div>
              ...
              <div className="mt-16 max-w-xl">
                <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-1 text-xs font-medium text-white/80">
                  <BadgeCheck className="h-3.5 w-3.5 text-[var(--color-login-gold)]" />
            ...
            <div className="grid gap-4">
              <div className="rounded-lg border border-white/15 bg-white/10 p-5 shadow-2xl shadow-black/20">
                <div className="flex items-center justify-between border-b border-white/10 pb-4">
                  ...
                  <span className="rounded-full bg-[var(--color-login-gold)] px-2.5 py-1 text-xs font-semibold text-[var(--color-brand-900)]">
                    Activo
                  </span>
                </div>
            ...
            <div className="rounded-lg border border-[var(--color-border)] bg-[var(--color-surface-elevated)] p-7 shadow-[0_24px_70px_rgba(15,23,42,0.10)] sm:p-8">
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <button
                  ...
                  className="flex h-11 w-full items-center justify-center gap-2 rounded-lg bg-[var(--color-accent)] px-4 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[var(--color-accent-strong)] disabled:cursor-not-allowed disabled:opacity-70"
                >
